...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Release.mk dist/Release/GNU-Linux-x86/imgproc

dist/Release/GNU-Linux-x86/imgproc: ${OBJECTFILES}
	${MKDIR} -p dist/Release/GNU-Linux-x86
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/imgproc ${OBJECTFILES} ${LDLIBSOPTIONS} 

${OBJECTDIR}/constraste.o: nbproject/Makefile-${CND_CONF}.mk constraste.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/constraste.o constraste.cpp
...
${OBJECTDIR}/histogramme.o: nbproject/Makefile-${CND_CONF}.mk histogramme.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/histogramme.o histogramme.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Release
	${RM} dist/Release/GNU-Linux-x86/imgproc
