...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Debug.mk ../test/imgproc

../test/imgproc: ${OBJECTFILES}
	${MKDIR} -p ../test
	${LINK.cc} -lcxcore -lcv -lhighgui -lcvaux -lml -o ../test/imgproc ${OBJECTFILES} ${LDLIBSOPTIONS} 
